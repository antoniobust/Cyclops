...
public enum McEnumUri {
    ...
    MS_ID(503, McContract.MANAGEMENT_SERVER_TABLE_NAME + "/*", true, McContract.MANAGEMENT_SERVER_TABLE_NAME),

    MS_LIST(504, McContract.MANAGEMENT_SERVER_TABLE_NAME, false, McContract.MANAGEMENT_SERVER_TABLE_NAME),

    MS_BY_SERVER(505, McContract.MANAGEMENT_SERVER_TABLE_NAME + "/server/*", false, McContract.MANAGEMENT_SERVER_TABLE_NAME),

    DS_ID(506, McContract.DEPLOYMENT_SERVER_TABLE_NAME + "/*", true, McContract.DEPLOYMENT_SERVER_TABLE_NAME),

    DS_LIST(507, McContract.DEPLOYMENT_SERVER_TABLE_NAME, false, McContract.DEPLOYMENT_SERVER_TABLE_NAME),

    DS_BY_SERVER(508, McContract.DEPLOYMENT_SERVER_TABLE_NAME + "/server/*", false, McContract.MANAGEMENT_SERVER_TABLE_NAME),
    ...
    USERS(514, McContract.USER_TABLE_NAME, false, McContract.USER_TABLE_NAME),

    USER_ID(514, McContract.USER_TABLE_NAME + "/*", true, McContract.USER_TABLE_NAME),

    USERS_BY_SERVER(515, McContract.USER_TABLE_NAME + "/server/*", false, McContract.USER_TABLE_NAME),

    PROFILES(514, McContract.PROFILE_TABLE_NAME, false, McContract.PROFILE_TABLE_NAME),

    PROFILE_DEVICE_ID(515, McContract.PROFILE_TABLE_NAME + "/device/*", true, McContract.PROFILE_TABLE_NAME),

    PROFILE_ID(516, McContract.PROFILE_TABLE_NAME + "/*", true, McContract.PROFILE_TABLE_NAME),

    SERVERS(517, McContract.SERVER_INFO_TABLE_NAME, false, McContract.SERVER_INFO_TABLE_NAME),

    SERVER_BY_NAME(518, McContract.SERVER_INFO_TABLE_NAME + "/*", true, McContract.SERVER_INFO_TABLE_NAME);
