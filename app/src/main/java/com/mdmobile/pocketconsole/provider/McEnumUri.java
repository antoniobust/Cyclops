...
public enum McEnumUri {
    ...
    INSTALLED_APPLICATIONS_ON_DEVICE(510, McContract.INSTALLED_APPLICATION_TABLE_NAME+"/*", false, McContract.INSTALLED_APPLICATION_TABLE_NAME ),

    INSTALLED_APPLICATION_ID(511, McContract.INSTALLED_APPLICATION_TABLE_NAME, true, McContract.INSTALLED_APPLICATION_TABLE_NAME),

    INSTALLED_APPLICATION_PKG_NAME(512, McContract.INSTALLED_APPLICATION_TABLE_NAME, true, McContract.INSTALLED_APPLICATION_TABLE_NAME);
