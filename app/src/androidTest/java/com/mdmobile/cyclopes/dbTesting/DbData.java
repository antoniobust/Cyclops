package com.mdmobile.cyclopes.dbTesting;
...
import com.mdmobile.cyclopes.dataModels.api.Profile;
import com.mdmobile.cyclopes.dataModels.api.RuntimeTypeAdapterFactory;
import com.mdmobile.cyclopes.dataModels.api.ServerInfo;
...
import com.mdmobile.cyclopes.dataModels.api.devices.SamsungKnoxDevice;
...
import com.mdmobile.cyclopes.fakeData.FakeJSON;
import com.mdmobile.cyclopes.provider.McContract;
import com.mdmobile.cyclopes.provider.McHelper;
...
//        assertTrue("DS not deleted properly, deleted: " + deleted + " records", deleted > 0);
    ...
    public void TestProfile() {
        ...
        InsertDevice();
        ContentValues[] val = com.mdmobile.cyclopes.utils.DbData.prepareProfilesValue(profiles);
    ...
    private void createSingleNewDevice() {
        ...
        ContentValues deviceValues = com.mdmobile.cyclopes.utils.DbData.prepareDeviceValues(devicesArray.get(0));
    ...
    private void createNewDevicesBulkImport() {
        ...
        if (devicesArray.size() > 1) {
            ContentValues[] devicesValues = com.mdmobile.cyclopes.utils.DbData.prepareDeviceValues(devicesArray);
    ...
    private void insertMs() {
        ...
        ContentValues[] msValues = com.mdmobile.cyclopes.utils.DbData.prepareMsValues(msArray);
    ...
    private void insertDs() {
        ...
        ContentValues[] dsValues = com.mdmobile.cyclopes.utils.DbData.prepareDsValues(dsArray);
