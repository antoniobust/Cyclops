...
open class SamsungElm(Kind: String = "N/A", DeviceId: String = "N/A", DeviceName: String = "N/A", EnrollmentTime: String = "N/A",
    ...
    : AndroidPlus(Kind, DeviceId, DeviceName, EnrollmentTime, Family, HostName, MACAddress, Manufacturer, Mode, Model,
        OSVersion, Path, ComplianceStatus, IsAgentOnline, IsVirtual, Platform, AgentVersion, HardwareSerialNumber, HardwareVersion,
        IMEI_MEID_ESN, CellularCarrier, LastLoggedOnUser, NetworkBSSID, Ipv6, NetworkSSID, OEMVersion,
