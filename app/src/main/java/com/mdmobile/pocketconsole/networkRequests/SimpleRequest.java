...
/**
 * This class is the copy of Volley StringRequest, it only extends my custom BasicRequest to implement
 * all the standard configurations
 */

public class SimpleRequest extends BasicRequest<String> {
