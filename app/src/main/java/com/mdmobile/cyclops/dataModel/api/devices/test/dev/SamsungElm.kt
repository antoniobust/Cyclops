...
import com.mdmobile.cyclops.dataModel.api.devices.test.CustomData
import com.mdmobile.cyclops.dataModel.api.devices.test.Memory

class SamsungElm(
        @SerializedName("ElmStatus") val elmStatus: String = "",
        ...
        @SerializedName("CustomData") val customData: List<CustomData> = listOf(),
        ...
        @SerializedName("SupportedApis") val supportedApis: List<Int> = listOf(),
