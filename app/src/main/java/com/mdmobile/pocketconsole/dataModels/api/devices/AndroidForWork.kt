...
class AndroidForWork(Kind: String = "N/A", DeviceId: String = "N/A", DeviceName: String = "N/A", EnrollmentTime: String = "N/A",
    ...
    : AndroidPlus(Kind, DeviceId, DeviceName, EnrollmentTime, Family, HostName, MACAddress, Manufacturer,
        ...
        BatteryStatus, CellularSignalStrength, NetworkConnectionType, NetworkRSSI, HardwareEncryptionCaps), IDevice<AndroidPlus> {
